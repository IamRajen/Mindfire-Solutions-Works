...
<cfcomponent output="false">
    ...
    <cffunction name="removeStopWords" access="remote" output="false" returntype="array">
        ...
        <cfset local.words = []/>
        <cfset local.stopWords = "a,able,about,across,after,all,almost,also,am,among,an,and,any,are,as,at,be,because,been,but,
        ...
        <cfloop list="#input#" index="word" delimiters=" ">
            <cfif NOT ListFind(local.stopWords, word)>
                <cfset arrayAppend(local.words, word)/>
            </cfif>
        </cfloop>
