...
<form class="form-inline my-2 my-lg-0 p-5" method="get" action="index.cfm">
    ...
    <small class='text-dark text-center w-100 p-2'><i>Search for batches and hit the search key.</i></small>
</form>