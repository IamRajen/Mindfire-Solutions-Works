...
<cf_header homeLink="index.cfm" logoPath="Images/logo.png" stylePath="Styles/style.css" scriptPath="Script/searchBatch.js">
    ...
    <div class="container">
        ...
        <cfif (structKeyExists(session, "stLoggedInUser") AND session.stLoggedInUser.role EQ 'Teacher') OR userDetails.overview.isTeacher>
            <div class="p-5">
                <h3 class="text-secondary">Batches:</h3>
                <cfif userDetails.batch.recordCount EQ 0>
